...
const API_KEY = "AIzaSyCFTwlh9fnbrP4yG17NNcMK64ZcEW1JBqA"
...
const generateBotResponse = async (incomingMessageDiv) => {
    ...
    // Push the user's message (and optional file) into chat history
    chatHistory.push({
        role: "user",
        parts: [
    ...
    try {
        ...
        // Temporary div to apply syntax highlighting
        ...
        // Push bot response into chat history
        chatHistory.push({
            role: "model",
            parts: [{ text: rawText }]
        });
